...
> = {
  ...
  seller_created: { label: "Empleado creado", color: "bg-teal-500", icon: Users },
  seller_updated: { label: "Empleado editado", color: "bg-amber-500", icon: Users },
  seller_deleted: { label: "Empleado eliminado", color: "bg-red-500", icon: Users },
